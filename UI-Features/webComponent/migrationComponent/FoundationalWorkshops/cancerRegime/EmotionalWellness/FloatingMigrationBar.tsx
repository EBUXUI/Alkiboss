...
export default function EmotionalWellnessFloatingMigrationBar() {
  return (
    <>
        ...
        <div className={styles.FloatingMigrationFlex}>
          <div className={styles.FloatingMigrationLogo}>
            ...
            <div className={styles.FloatingMigrationTitle}>
              <h1 className={`${styles["FloatingMigrationTitle"]}`}> Emotional Wellness <span className={styles.FloatingMigrationLimitedCo}> Regime </span></h1>
            </div>
          </div>
        </div>
      </section>
