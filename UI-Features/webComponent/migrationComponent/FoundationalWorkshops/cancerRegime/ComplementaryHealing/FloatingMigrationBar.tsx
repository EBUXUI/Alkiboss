...
export default function ComplementaryHealingMigrationBar() {
  return (
    <>
        ...
        <div className={styles.FloatingMigrationFlex}>
          <div className={styles.FloatingMigrationLogo}>
            ...
            <div className={styles.FloatingMigrationTitle}>
              <h1 className={`${styles["FloatingMigrationTitle"]}`}> Complementary Healing <span className={styles.FloatingMigrationLimitedCo}> Regime </span></h1>
            </div>
          </div>
        </div>
      </section>
