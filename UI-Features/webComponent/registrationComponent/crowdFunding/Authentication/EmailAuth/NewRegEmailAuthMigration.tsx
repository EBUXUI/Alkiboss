...
import OperatingUserLoginContent from '@/UI-Features/webComponent/registrationComponent/crowdFunding/Authentication/EmailAuth/NewRegEmailAuthContent';
import NavigateForgotUserHome from '@/UI-Features/webComponent/registrationComponent/crowdFunding/Authentication/EmailAuth/NavigateEmailRegAuthHome';
              ...
              <div className={styles.CompanyGridedLogo}>
                ...
                >
                  ...
                  <div className={styles.ProductGridColumn}>
                    <div className={styles.ProductPurchase}>
                      <Link
                        href="/FoundationEntry/CrowdFunding/Registration/AuthOps/QRAuth"
                        className={styles.PurchaseLink}
                      >
                        Scan QR Code
                      </Link>
