...
import PrintingAccessories from "@/UI-Features/UI-Gallery/Luvra/RefineEntryI.jpg";
...
export default function UsingEntriesBtn({ setActivePage }: RefineOptions) {
  const imageData = [
    {
