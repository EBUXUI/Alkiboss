...
import PrintingAccessories from "@/UI-Features/UI-Gallery/Luvra/StoreEntryXI.jpg";
...
export default function UsingClausesBtn({ setActivePage }: StoreOptions) {
  const imageData = [
    {
