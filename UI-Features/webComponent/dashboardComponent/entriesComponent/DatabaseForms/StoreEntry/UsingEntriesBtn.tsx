...
import PrintingAccessories from "@/UI-Features/UI-Gallery/Luvra/StoreEntryXXXI.jpg";
...
export default function UsingEntriesBtn({ setActivePage }: StoreOptions) {
  const imageData = [
    {
