...
import PrintingAccessories from "@/UI-Features/UI-Gallery/Luvra/EraseEntryXXXIV.jpg";
...
export default function UsingEntriesBtn({ setActivePage }: EraseOptions) {
  const imageData = [
    {
