...
import PrintingAccessories from "@/UI-Features/UI-Gallery/Luvra/EraseEntryXXXV.jpg";
...
export default function UsingClausesBtn({ setActivePage }: EraseOptions) {
  const imageData = [
    {
