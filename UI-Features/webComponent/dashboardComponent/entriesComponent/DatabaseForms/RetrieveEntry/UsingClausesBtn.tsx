...
import PrintingAccessories from "@/UI-Features/UI-Gallery/Luvra/LuvraXXVII.jpg";
...
export default function UsingClausesBtn({ setActivePage }: RetrieveOptions) {
  const imageData = [
    {
