...
import HeroComponent from '@/UI-Features/webComponent/dashboardComponent/automationComponent/EarthBuilder/HeroComponent/typeBComponent';
import FooterComponent from '@/UI-Features/webComponent/dashboardComponent/automationComponent/EarthBuilder/FooterComponent';


export default function InstallEarthComponent() {
