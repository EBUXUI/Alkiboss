...
import { faAtom, faBiking, faBolt, faBrain, faClose, faCoffee, faDiagnoses, faHeart, faHospital, faLandmark, faLeaf, faMoneyBill, faMoneyBill1, faNewspaper, faSyringe, faUsers, faWind } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className={styles.SideBarCompany}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faLandmark} />
          </label>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faBrain} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faBiking} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faCoffee} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faDiagnoses} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faHeart} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faHospital} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faSyringe} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faLeaf} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faWind} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon
              ...
              icon={showIntroIcon ? faClose : faMoneyBill}
        ...
        {showIntroIcon && (
          <section className={styles.DropDownBg}>
            <article className={styles.SideBarComponent}>
              <label className={styles.SideBarActive}>
                <FontAwesomeIcon className={styles.SideBarNav} icon={faMoneyBill1} />
              </label>
              <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faAtom} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faUsers} />
          </label>
          <label className={styles.SideBarTitle}>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faBolt} />
          </label>
          <label className={styles.SideBarTitle}>
            <Link className={styles.DashboardGrid} href='/Dashboard/Settings'>
        ...
        <article className={styles.SideBarComponent}>
          <label className={styles.SideBarActive}>
            <FontAwesomeIcon className={styles.SideBarNav} icon={faNewspaper} />
          </label>
          <label className={styles.SideBarTitle}>
