...
import { getLuvSQLExecutor } from "@/UI-Features/SQLComponent/Instances";
...
export default async function FinanvraBlueprint() {
  ChartJS.register(
    CategoryScale,
    LinearScale,
    Tooltip,
  ...
  async function fetchData(){
    try{
      const response = await fetch('/api/finanvra-data', {cache: 'no-store'});
      if(!response.ok){
