...
import NewRegListing from '@/UI-Features/webComponent/listingComponent/entryComponent/TheHealthDashboard/ListingRegSession';
import RegPictorial from '@/UI-Features/webComponent/heroComponent/TheHealthDashboard/NewPictorial';
import Link from 'next/link';
import NavigateManager from '@/UI-Features/webComponent/heroComponent/InnovativeSolutions/RegimeComponent/cancerRegime/EmotionalWellness/NavigateNew';
...
export default function TheHealthDashboardRegistration() {
    //useEffect(() => {
    ...
    return (
        <>
            <Head>
                <title>New Registration | The Health Dashboard</title>
