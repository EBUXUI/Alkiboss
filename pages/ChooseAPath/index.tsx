...
import LoginListing from '@/UI-Features/webComponent/listingComponent/entryComponent/TheHealthDashboard';
import LoginPictorial from '@/UI-Features/webComponent/backgroundComponent/credentialsComponent/LoginPictorial';
import FloatingMigrationBar from '@/UI-Features/webComponent/migrationComponent/FloatingMigrationBar';
import Link from 'next/link';

export default function FoundationaEntry() {
    //useEffect(() => {
    ...
    return (
        <>
            <Head>
                <title>The Health Platform | House of Grace </title>
