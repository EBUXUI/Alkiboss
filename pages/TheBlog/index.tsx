...
import styles from '@/styles/Menu/White/Home.module.css'
...
import ProgrammesModule from '@/UI-Features/webComponent/moduleComponent/FoundationalBlog';
import ClosingHero from '@/UI-Features/webComponent/heroComponent/MainHero';
export default function Home() {
    ...
    return (
        <>
            <Head>
                <title>The Foundational Blog | Supporting Disabled Children & Cancer Patients</title>
            ...
            <section className={styles.ResNav}>
                <MenuHero />
            </section>
        </>
    )
