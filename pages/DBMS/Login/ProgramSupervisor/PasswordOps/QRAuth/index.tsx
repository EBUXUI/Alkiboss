...
import OperatingSupervisorListing from "@/Partitions/MainListing/ListingSupervisorPassOpsQRAuth";
import OperatingSupervisorPictorial from "@/Partitions/OperatingSupervisor/OperatingSupervisorPictorial";
//import Link from 'next/link';
import NavigateSupervisor from "@/Partitions/Migration/FloatingMigrationBarIV";

export default function OperatingSupervisorPassOpsQRAuth() {
  //useEffect(() => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>Password QR Auth | Supervisor Auth |Finanvra Recovery </title>
        <meta
          name="description"
