...
import OperatingSupervisorListing from '@/Partitions/MainListing/ListingSupervisorPassOps';
...
export default function OperatingSupervisorPassOps() {
    //useEffect(() => {
   ...
   // }, [])
    ...
    return(
        <>
         <Head>
                 {/* Primary Meta Tags */}
                 <title>Forgot Password | Supervisor Auth |Finanvra Recovery </title>
                 <meta
                   name="description"
