...
import OperatingSupervisorListing from '@/Partitions/MainListing/ListingSupervisorPassOpsEmailAuth';
import OperatingSupervisorPictorial from '@/Partitions/OperatingSupervisor/OperatingSupervisorPictorial';
//import Link from 'next/link';
import NavigateSupervisor from '@/Partitions/Migration/FloatingMigrationBarII';

export default function OperatingSupervisorPassOpsEmailAuth() {
    //useEffect(() => {
   ...
   // }, [])
    ...
    return(
        <>
         <Head>
                 {/* Primary Meta Tags */}
                 <title>Password Email Auth | Supervisor Auth |Finanvra Recovery </title>
                 <meta
                   name="description"
