...
import OperatingSupervisorListing from "@/Partitions/MainListing/ListingSupervisorUserOpsQRAuth";
...
export default function OperatingSupervisorUserOpsQRAuth() {
  //useEffect(() => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>QR Username Auth | Supervisor Auth |Finanvra Recovery </title>
        <meta
          name="description"
