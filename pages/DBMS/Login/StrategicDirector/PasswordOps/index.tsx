...
import OperatingManagerListing from "@/Partitions/MainListing/ListingManagerPassOps";
import OperatingManagerPictorial from "@/Partitions/OperatingManager/OperatingManagerPictorial";
//import Link from 'next/link';
import NavigateManager from "@/Partitions/Migration/FloatingMigrationBarII";

export default function OperatingManagerPassOps() {
  //useEffect(() => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>Forgot Password | Manager Auth |Finanvra Recovery </title>
        <meta
          name="description"
