...
import OperatingManagerListing from "@/Partitions/MainListing/ListingManagerPassOpsEmailAuth";
...
export default function OperatingManagerPassOpsEmailAuth() {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>Email Password Auth | Manager Auth |Finanvra Recovery </title>
        <meta
          name="description"
