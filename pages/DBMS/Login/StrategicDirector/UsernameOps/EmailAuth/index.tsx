...
import OperatingManagerListing from "@/Partitions/MainListing/ListingManagerUserOpsEmailAuth";
import OperatingManagerPictorial from "@/Partitions/OperatingManager/OperatingManagerPictorial";
//import Link from 'next/link';
import NavigateManager from "@/Partitions/Migration/FloatingMigrationBarI";

export default function OperatingManagerUserOpsEmailAuth() {
  //useEffect(() => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>Username Email Auth | Manager Auth |Finanvra Recovery </title>
        <meta
          name="description"
          content="Finanvra is a secure and intelligent financial management platform that simplifies fund registration, transfers, withdrawals, investments, and portfolio monitoring. Built on advanced automation protocols and bank-grade security, Finanvra empowers managers, supervisors, and users with seamless control of their finances."
        />
        <meta
          name="keywords"
