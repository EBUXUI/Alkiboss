...
import OperatingManagerListing from "@/Partitions/MainListing/ListingManagerUserOpsQRAuth";
...
export default function OperatingManagerUserOpsQRAuth() {
  //useEffect(() => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>QR Username Code | Manager Auth |Finanvra Recovery </title>
        <meta
          name="description"
