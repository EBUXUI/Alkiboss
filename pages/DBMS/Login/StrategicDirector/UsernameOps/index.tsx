...
import OperatingManagerListing from "@/Partitions/MainListing/ListingManagerUserOps";
...
export default function OperatingManagerUserOps() {
  //useEffect(() => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>Forgot Username | Manager Auth |Finanvra Recovery </title>
        <meta
          name="description"
